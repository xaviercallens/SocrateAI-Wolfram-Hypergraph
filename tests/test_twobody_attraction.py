...
def test_twobody_geodesic_attraction():
    ...
    print(
        f"Initial Geodesic Distance: {res['two_body_setup']['initial_geodesic_distance']}")
    print(
        f"Final Geodesic Distance at step 7: {res['final_geodesic_distance']}")
    print(
        f"Delta d (Gravitational Attraction): {res['delta_geodesic_distance']}")
